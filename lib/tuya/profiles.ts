...
export const PROFILES: Record<string, DeviceProfile> = {
  ...
  humidifier: {
    ...
    mapping: {
      ...
      dim: { dp: '3', transform: 'divideBy100' },
      humidifier_target_humidity: { dp: '4' },
  ...
  dehumidifier: {
    ...
    requiredDps: ['1'],
    optionalDps: ['2', '4', '5', '6', '7', '10', '11', '103', '104'],
    mapping: {
      onoff: { dp: '1' },
      dehumidifier_mode: {
        dp: '2',
      ...
      dehumidifier_target_humidity: { dp: '4' },
      dehumidifier_fan_speed: {
        dp: '6',
        valueMap: { '1': 'low', '2': 'middle', '3': 'high' },
        reverseValueMap: { 'low': '1', 'middle': '2', 'high': '3' },
      },
      dehumidifier_anion: { dp: '10' },
      measure_temperature: { dp: '103' },
      measure_humidity: { dp: '104' },
    },
  },
